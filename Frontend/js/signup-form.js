...
signupBtn.addEventListener('click', (e) => {
    ...
    if(emptyFieldValidate() && validators() && passwordMatchValidate()) {
        ...
        const url = "http://localhost/twitter-clone-fullstack/backend/signup-api.php"
        let data
       if(is_email_null()) {
        data = {
            "name": name.value,
       ...
       const usrnameExistUrl = "http://localhost/twitter-clone-fullstack/backend/username-exist-api.php"
        ...
        .then((d) => {
            ...
            const emailExistUrl = "http://localhost/twitter-clone-fullstack/backend/email-exist-api.php"
            ...
            .then(d => {
                ...
                const phoneExistUrl = "http://localhost/twitter-clone-fullstack/backend/phone-exist-api.php"
                ...
                .then(d => {
                    ...
                    location.replace("http://localhost/twitter-clone-fullstack/frontend/feed.html")
